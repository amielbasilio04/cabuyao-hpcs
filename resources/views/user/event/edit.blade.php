        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            <a class="btn btn_green text-decoration-none text-white" href="{{ route('brgy_admin.event.index') }}"><i class="fas fa-chevron-left me-1"></i>Go Back</a>
                        ...
                        <div class="col-md-6">
                            ...
                            <form action="{{ route('brgy_admin.event.update', $event->id) }}" method="post">
                                ...
                                <div class="form-group mb-2">
                                    ...
                                    <input class="form-control" type="datetime-local" min="2021-10-01T00:00" max="2022-01-01T00:00" name="time_start" value="{{ formatDate($event->time_start,"dateTimeLocal") }}" required>
                                </div>
                                <div class="form-group mb-3">
                                    <label class="form-label">DateTime End *</label>
                                    <input class="form-control" type="datetime-local" min="2021-10-01T00:00" max="2022-01-01T00:00" name="time_end"  value="{{ formatDate($event->time_end,"dateTimeLocal") }}" required>
