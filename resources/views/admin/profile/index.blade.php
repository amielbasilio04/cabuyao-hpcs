...
<div class="container">
    ...
    <div class="row justify-content-center align-items-center">
        <form action="{{ route('city_admin.profile.update',auth()->id()) }}" method="POST" class="col-md-4" >
           @csrf @method('PUT')
           ...
           @endif
            ...
            <button class="btn btn_green form-control">Submit <i class="fas fa-paper-plane ml-1"></i> </button>
    </div>
</div>
{{--End CONTAINER--}}
