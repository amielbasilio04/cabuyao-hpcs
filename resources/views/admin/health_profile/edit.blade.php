...
@section('title', 'Admin | Edit Health Profile')
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <a class="btn btn_navy_blue text-decoration-none text-white" href="{{ route('city_admin.health_profile.index') }}"><i class="fas fa-chevron-left me-1"></i>Go Back</a>
                </div>
                <div class="card-body">
                  <form action="{{ route('city_admin.health_profile.update', $health_profile->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="row justify-content-center">
                        <div class="col-md-4">
