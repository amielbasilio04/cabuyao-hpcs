                ...
                <div class="w-100">
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="card bg_navy_blue">
                                <div class="card-body d-flex and flex-column">
                                    <a href="{{ route('city_admin.barangay.index') }}" class="card-title mb-4 text-white text-decoration-none">Total Barangay</a>
                                    <h1 class="mt-1 mb-3 text-white">{{ $total_barangays }}</h1>
                                </div>
                            </div>
                            <div class="card bg_green">
                                <div class="card-body d-flex and flex-column">
                                    <a href="{{ route('city_admin.resident.index') }}" class="card-title mb-4 text-white text-decoration-none">Total Residents</a>
                                    <h1 class="mt-1 mb-3 text-white">{{ $total_residents }}</h1>
                                </div>
                            </div>
                            <div class="card bg_navy_blue">
                                <div class="card-body d-flex and flex-column">
                                    <a href="{{ route('city_admin.event.index') }}" class="card-title mb-4 text-white text-decoration-none">Total Events</a>
                                    <h1 class="mt-1 mb-3 text-white">{{ $total_events }}</h1>
                                </div>
                            </div>
                            <div class="card bg_green">
                                <div class="card-body d-flex and flex-column">
                                    <a href="{{ route('city_admin.health_issue.index') }}" class="card-title mb-4 text-white text-decoration-none">Total Health Issues</a>
                        ...
                        <div class="col-sm-6">
                            <div class="card bg_navy_blue">
                                <div class="card-body d-flex and flex-column">
                                    <a href="{{ route('city_admin.barangay_admin.index') }}" class="card-title mb-4 text-white text-decoration-none">Total Barangay Admin</a>
                                    <h1 class="mt-1 mb-3 text-white">{{ $total_barangay_admins }}</h1>
                                </div>
                            </div>
                            <div class="card bg_green">
                                <div class="card-body d-flex and flex-column">
                                    <a href="{{ route('city_admin.health_profile.index') }}" class="card-title mb-4 text-white text-decoration-none">Total Health Profile</a>
                                    <h1 class="mt-1 mb-3 text-white">{{ $total_health_profiles }}</h1>
                                </div>
                            </div>
                            <div class="card bg_navy_blue">
                                <div class="card-body d-flex and flex-column">
                                    <a href="{{ route('city_admin.event.index') }}" class="card-title mb-4 text-white text-decoration-none">Total Pending Events</a>
                                    <h1 class="mt-1 mb-3 text-white">{{ $total_pending_events }}</h1>
                                </div>
                            </div>
                            <div class="card bg_green">
                                <div class="card-body d-flex and flex-column">
                                    <a href="{{ route('city_admin.event.index') }}" class="card-title mb-4 text-white text-decoration-none">Total Canceled Events</a>
